...
import 'package:musicalxs/widgets/ConstruirListaHimnos.dart';
  ...
  /*      child: AppBar(
          ...
          */
          child: Container(decoration: BoxDecoration(gradient: LinearGradient(
            colors: [etiquetaColor, ObtenerColoresEtiqueta1Gradiente(etiquetaColor)],
              ...
              onPressed: () async {
                ...
                if (actualizado == true) {
                  ...
                  cargarDatos().then((data) {
                    setState(() {
                      listas = List.from(listasApp);
                      himnosApp = data;
                      clasificarHimnos(data['himnos']);
                    });
                  });
                }
              },
            ...
            child: Container(
              ...
              child: ListView(
                children: [
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Padding(padding: EdgeInsets.symmetric(horizontal: 6.0, vertical: 0.0), child: formatearConNotas(widget.contenido, tonoOffset)),
                      SizedBox(height: 20),
                      Text(
                        "Autor: ${widget.autor}",
