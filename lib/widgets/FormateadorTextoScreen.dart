...
class _FormateadorTextoScreenState extends State<FormateadorTextoScreen> {
        ...
        final notaWidget = Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(gradient: LinearGradient(colors: [etiquetaColor, ObtenerColoresEtiqueta1Gradiente(etiquetaColor)],begin: Alignment.topLeft,end: Alignment.bottomRight,), borderRadius: BorderRadius.circular(6)),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Formatear de Texto"), flexibleSpace: Padding(padding: EdgeInsets.symmetric(horizontal: 0.0, vertical: 2.0)), backgroundColor: Colors.transparent, automaticallyImplyLeading: false, actions: [
          IconButton(
